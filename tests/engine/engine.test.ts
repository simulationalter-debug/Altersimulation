...
import { ewmaRate, percentile } from "@/features/simulations/engine/ewma";
import { timelinePctRaw, computeGoalFutureTimeline, requiredRate } from "@/features/simulations/engine/trajectory";
import { computeGoalGhostTimeline } from "@/features/simulations/engine/ghost";
import { computeGoalPayload, computeDaysToTarget } from "@/features/simulations/engine/payload";
import { applyDecisionEvent } from "@/features/simulations/engine/decisions";
import { simulateOptions } from "@/features/simulations/engine/simulate";
import { assertFitnessGoalSafe, detectLowState } from "@/features/simulations/engine/safety";
import { DEFAULT_TUNING, type Action, type Goal } from "@/features/simulations/engine/types";
